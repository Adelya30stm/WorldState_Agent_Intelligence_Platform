...
func TestGetSecretPatterns_PatternCompilation(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			name: "Tavily",
			config: &Config{
				TavilyAPIKey: "test-tavily-api-key",
			},
		},
		{
			name: "Google",
			config: &Config{
				...
				GoogleCXKey:     "test-google-cx-key",
			},
		},
		{
			name: "OAuth",
			config: &Config{
				OAuthGoogleClientID:     "test-google-client-id",
				OAuthGoogleClientSecret: "test-google-client-secret",
				OAuthGithubClientID:     "test-github-client-id",
				OAuthGithubClientSecret: "test-github-client-secret",
			},
		},
		{
			name: "Database",
