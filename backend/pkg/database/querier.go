...
type Querier interface {
	AcceptClaimedPrimaryWorldStateResume(ctx context.Context, arg AcceptClaimedPrimaryWorldStateResumeParams) (AgentChainWait, error)
	AcknowledgeAgentTaskUpdatesExact(ctx context.Context, arg AcknowledgeAgentTaskUpdatesExactParams) ([]AcknowledgeAgentTaskUpdatesExactRow, error)
	AddFavoriteFlow(ctx context.Context, arg AddFavoriteFlowParams) (UserPreference, error)
	AdvanceWorldStateChainCursor(ctx context.Context, arg AdvanceWorldStateChainCursorParams) (WorldStateChainCursor, error)
	BindAgentTaskUpdateRecipient(ctx context.Context, arg BindAgentTaskUpdateRecipientParams) (AgentTaskUpdate, error)
	ClaimPrimaryWorldStateResumeForController(ctx context.Context, arg ClaimPrimaryWorldStateResumeForControllerParams) (AgentChainWait, error)
	...
	CreateWorldStateEvent(ctx context.Context, arg CreateWorldStateEventParams) (WorldStateEvent, error)
	...
	GetPendingAgentTaskUpdateHead(ctx context.Context, arg GetPendingAgentTaskUpdateHeadParams) (int64, error)
	GetPendingAgentTaskUpdatesForRecipient(ctx context.Context, arg GetPendingAgentTaskUpdatesForRecipientParams) ([]AgentTaskUpdate, error)
	GetPendingAgentTaskUpdatesForTarget(ctx context.Context, arg GetPendingAgentTaskUpdatesForTargetParams) ([]AgentTaskUpdate, error)
	...
	GetSelectedWorldStateEvents(ctx context.Context, arg GetSelectedWorldStateEventsParams) ([]WorldStateEvent, error)
	...
	GetWorldStateChainCursor(ctx context.Context, msgchainID int64) (WorldStateChainCursor, error)
	GetWorldStateEntitiesByFlow(ctx context.Context, flowID int64) ([]WorldStateEntity, error)
	GetWorldStateEntityByID(ctx context.Context, id int64) (WorldStateEntity, error)
	GetWorldStateEntityByKey(ctx context.Context, arg GetWorldStateEntityByKeyParams) (WorldStateEntity, error)
	GetWorldStateEventHead(ctx context.Context, flowID int64) (int64, error)
	GetWorldStateEventsByRevision(ctx context.Context, arg GetWorldStateEventsByRevisionParams) ([]WorldStateEvent, error)
	GetWorldStateLinksByFlow(ctx context.Context, flowID int64) ([]WorldStateLink, error)
	GetWorldStateTransitionsByEntity(ctx context.Context, entityID int64) ([]WorldStateTransition, error)
	GetWorldStateTransitionsByFlow(ctx context.Context, arg GetWorldStateTransitionsByFlowParams) ([]GetWorldStateTransitionsByFlowRow, error)
	InsertWorldStateEntity(ctx context.Context, arg InsertWorldStateEntityParams) (WorldStateEntity, error)
	InsertWorldStateLink(ctx context.Context, arg InsertWorldStateLinkParams) (WorldStateLink, error)
	...
	LockAgentSpecialistMsgchain(ctx context.Context, arg LockAgentSpecialistMsgchainParams) (Msgchain, error)
	LockAgentSubtaskTargetLifecycle(ctx context.Context, arg LockAgentSubtaskTargetLifecycleParams) (Subtask, error)
	...
	LockWorldStateEntityByKey(ctx context.Context, arg LockWorldStateEntityByKeyParams) (WorldStateEntity, error)
	LockWorldStateLink(ctx context.Context, arg LockWorldStateLinkParams) (WorldStateLink, error)
	MergeWorldStateEntityProperties(ctx context.Context, arg MergeWorldStateEntityPropertiesParams) (WorldStateEntity, error)
	MergeWorldStateLinkProperties(ctx context.Context, arg MergeWorldStateLinkPropertiesParams) (WorldStateLink, error)
	RejectAgentTaskUpdate(ctx context.Context, arg RejectAgentTaskUpdateParams) (AgentTaskUpdate, error)
	RejectPendingAgentTaskUpdatesForTarget(ctx context.Context, arg RejectPendingAgentTaskUpdatesForTargetParams) ([]AgentTaskUpdate, error)
	ReleaseAgentChainWaitLease(ctx context.Context, arg ReleaseAgentChainWaitLeaseParams) (AgentChainWait, error)
	ReleasePrimaryWorldStateResumeLease(ctx context.Context, arg ReleasePrimaryWorldStateResumeLeaseParams) (AgentChainWait, error)
	...
	UpdateWorldStateEntityState(ctx context.Context, arg UpdateWorldStateEntityStateParams) (WorldStateEntity, error)
	UpsertAgentChainWait(ctx context.Context, arg UpsertAgentChainWaitParams) (AgentChainWait, error)
