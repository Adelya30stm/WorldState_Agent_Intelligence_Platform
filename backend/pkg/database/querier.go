...
type Querier interface {
	...
	UpsertWorldStateEntity(ctx context.Context, arg UpsertWorldStateEntityParams) (WorldStateEntity, error)
	UpsertWorldStateLink(ctx context.Context, arg UpsertWorldStateLinkParams) (WorldStateLink, error)
}
