...
var ErrPlanningInvalidRequest = NewHttpError(400, "Planning.InvalidRequest", "invalid planning extract request")
var ErrExecInvalidRequest = NewHttpError(400, "Exec.InvalidRequest", "invalid exec request")
