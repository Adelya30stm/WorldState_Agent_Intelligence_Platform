...
func parseFlags(args []string) Config {
	...
	flagSet.Usage = func() {
		fmt.Fprintf(os.Stderr, "RedScope Installer v%s\n\n", version.GetBinaryVersion())
...
func createInitialEnvFile(path string) error {
	...
	content = fmt.Appendf(nil, `# RedScope Environment Configuration
# Generated by RedScope Installer v%s
#
# This file contains environment variables for RedScope configuration.
...
func printStartupInfo(envPath string, checkResult checker.CheckResult) {
	fmt.Printf("RedScope Installer v%s\n", version.GetBinaryVersion())
