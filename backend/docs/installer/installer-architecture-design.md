# RedScope Installer Architecture & Design Patterns

> Architecture patterns, design decisions, and implementation strategies specific to the RedScope installer.
