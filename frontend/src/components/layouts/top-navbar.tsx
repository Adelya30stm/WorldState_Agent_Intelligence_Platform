...
const PENTEST_TYPES = [
    { label: 'Web Pentest',    sub: '7-phase OWASP methodology',  path: '/web-pentest'          },
    { label: 'Infrastructure', sub: 'Network & system assessment', path: '/infrastructure-pentest' },
...
const CENTER_NAV = [
    ...
    { label: 'Findings',   path: '/web-pentest/findings', exact: true  },
    { label: 'Phases',     path: '/web-pentest/phases',   exact: true  },
    { label: 'Reports',    path: '/web-pentest/reports',  exact: true  },
] as const;
...
const TopNavbar = () => {
    ...
    return (
        <>
            {/* ── Main bar ── */}
            <header className="sticky top-0 z-50 flex h-14 shrink-0 items-center gap-0 border-b bg-background px-6">
                {/* Left: project type dropdown */}
                <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                        <button className="flex items-center gap-2 rounded-lg px-2.5 py-2 text-sm font-semibold transition-colors hover:bg-accent mr-4 outline-none">
                            <ShieldCodeIcon className="size-7 shrink-0" />
                            <span className="hidden sm:block">{currentType.label}</span>
                        ...
                        {PENTEST_TYPES.map((item) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    {isActive && <Check className="size-4 text-blue-600 shrink-0" />}
                                </DropdownMenuItem>
                            );
                        })}
                    </DropdownMenuContent>
                ...
                <div className="flex items-center gap-2">
                    ...
                    <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                            <button className="flex items-center gap-2 rounded-lg border border-border bg-background px-2.5 py-1.5 text-sm transition-colors hover:bg-accent outline-none ml-1">
                        ...
                        <DropdownMenuContent align="end" className="min-w-52 rounded-lg" sideOffset={4}>
