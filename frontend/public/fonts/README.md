# Fonts
This directory contains web fonts used in the RedScope frontend application.
## Inter
...
Both fonts are open source and freely redistributable under their respective licenses.
